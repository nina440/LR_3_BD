...
<form action="index.php" id="addForm" method="post"> <!-- Изменение метода на POST -->
    ...
    <table>
        <tr>
            <td><input type="text" name="taxId" id="taxId" placeholder="ИНН" required /></td>
            <td><input type="text" name="entityType" id="entityType" placeholder="Физ./юрид. лицо" required /></td>
            <td><input type="text" name="addressName" id="addressName" placeholder="Адрес" required /></td>
            <td><input type="text" name="amount" id="amount" placeholder="Сумма" required /></td>
            <td><input type="text" name="conditions" id="conditions" placeholder="Условия" required /></td>
            <td><input type="text" name="legalNotes" id="legalNotes" placeholder="Юр. примечания" required /></td>
            <td><input type="text" name="contractsList" id="contractsList" placeholder="Список договоров" required /></td>
            <td><input type="submit" name="bt1" value="Добавить" class="bt" /></td>
        </tr>
    </table>
    <p style="font-size:12px;"><i>(в базу <b>bank_db</b>, таблицу <b>Brrowers</b> в MySQL)</i></p>
    <hr />
</form>
...
<div class="modal" data-modal="1">
   ...
   <br /><i>ИНН:</i> <input type="edit" name="taxId" id="textEd1" value="" /><br />
   <br /><i>Физ./юрид. лицо:</i> <input type="edit" name="entityType" id="textEd2" value="" /><br />
   <br /><i>Адрес:</i> <input type="edit" name="addressName" id="textEd3" value="" /><br />
   <br /><i>Сумма:</i> <input type="edit" name="amount" id="textEd4" value="" /><br />
   <br /><i>Условия:</i> <input type="edit" name="conditions" id="textEd5" value="" /><br />
   <br /><i>Юр. примечания:</i> <input type="edit" name="legalNotes" id="textEd6" value="" /><br />
   <br /><i>Список договоров:</i> <input type="edit" name="contractsList" id="textEd7" value="" /><br />
